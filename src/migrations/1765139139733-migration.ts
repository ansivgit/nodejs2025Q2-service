...
export class Migration1765139139733 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "favs_artists" ("favsId" character varying NOT NULL, "artistId" uuid NOT NULL, CONSTRAINT "PK_55457e38bc2ef5367bbcd9ecb0d" PRIMARY KEY ("favsId", "artistId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "favs_albums" ("favsId" character varying NOT NULL, "albumId" uuid NOT NULL, CONSTRAINT "PK_e457130a771a9b3282a18ce429c" PRIMARY KEY ("favsId", "albumId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "favs_tracks" ("favsId" character varying NOT NULL, "trackId" uuid NOT NULL, CONSTRAINT "PK_4d0ff4f8775a38289cdbb35d43e" PRIMARY KEY ("favsId", "trackId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "favs_artists" ADD CONSTRAINT "FK_08f8a0882594d24d359545372b0" FOREIGN KEY ("artistId") REFERENCES "artist"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "favs_albums" ADD CONSTRAINT "FK_ae8008eca87227ab48a6603d586" FOREIGN KEY ("albumId") REFERENCES "album"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "favs_tracks" ADD CONSTRAINT "FK_07ed537531349b00cfd8c58919d" FOREIGN KEY ("trackId") REFERENCES "track"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
